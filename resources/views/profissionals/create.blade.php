  ...
  <form method="POST" action="{{ route('profissionals.store') }}">
    ...
    <div class="form-row">
      <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" name="registroClasse" id="registroClasse" value="{{ old('registroClasse') ?? '' }}">
      </div>
      <div class="form-group col-md-6">  
        <label for="orgao_emissor_id">Orgão Emissor</label>
        <select class="form-control" name="orgao_emissor_id" id="orgao_emissor_id">
          <option value="1" selected="true">Não Possui</option>        
      ...
      <div class="form-group col-md-2">  
        ...
        <input type="text" class="form-control" name="ufOrgaoEmissor" id="ufOrgaoEmissor" value="{{ old('ufOrgaoEmissor') ?? '' }}" maxlength="2" style="text-transform:uppercase">
      </div>
    </div>
