...
<div class="container-fluid">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('equipegestao.index') }}">Gestão de Equipes</a></li>
    </ol>
  </nav>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form method="GET" action="{{ route('equipegestao.index') }}">
            ...
            <a href="{{ route('equipegestao.index') }}" class="btn btn-primary btn-sm" role="button">Limpar</a>
          </form>
          <br>
