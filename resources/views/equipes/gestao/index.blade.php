                ...
                <x-dropdown-menu title='Reports' icon='printer'>
                    ...
                    <li>
                        <a class="dropdown-item"
                            href="{{ route('equipegestao.export.xls', ['descricao' => request()->input('descricao'), 'numero' => request()->input('numero'), 'cnes' => request()->input('cnes'), 'ine' => request()->input('ine'), 'minima' => request()->input('minima'), 'unidade' => request()->input('unidade'), 'distrito' => request()->input('distrito'), 'tipo' => request()->input('tipo')]) }}"><x-icon
                                icon='file-earmark-spreadsheet-fill' /> {{ __('Export') . ' XLS' }}</a>
                    </li>
                    <li>
                        <a class="dropdown-item"
                            href="{{ route('equipegestao.export.csv', ['descricao' => request()->input('descricao'), 'numero' => request()->input('numero'), 'cnes' => request()->input('cnes'), 'ine' => request()->input('ine'), 'minima' => request()->input('minima'), 'unidade' => request()->input('unidade'), 'distrito' => request()->input('distrito'), 'tipo' => request()->input('tipo')]) }}"><x-icon
                                icon='file-earmark-spreadsheet-fill' /> {{ __('Export') . ' CSV' }}</a>
                    </li>
                    <li>
                        <a class="dropdown-item"
                            href="{{ route('equipegestao.export.pdf', ['descricao' => request()->input('descricao'), 'numero' => request()->input('numero'), 'cnes' => request()->input('cnes'), 'ine' => request()->input('ine'), 'minima' => request()->input('minima'), 'unidade' => request()->input('unidade'), 'distrito' => request()->input('distrito'), 'tipo' => request()->input('tipo')]) }}"><x-icon
                            ...
                            <td>
                                @can('gestao.equipe.show')
                                    <x-btn-group label='Opções'>
                                        <a href="{{ route('equipegestao.show', $equipe->id) }}" class="btn btn-info btn-sm"
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" id="descricao" name="descricao"
                            value="{{ session()->get('equipe_descricao') }}">
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        {{-- Reset the Filter --}}
                        <a href="{{ route('equipegestao.index', ['descricao' => '', 'numero' => '', 'cnes' => '', 'ine' => '', 'minima' => '', 'unidade' => '', 'distrito' => '', 'tipo' => '']) }}"
